 ...
 */
public class HealthierCaterersMap extends Fragment implements OnMapReadyCallback{
    SupportMapFragment mapFragment;
    GoogleMap mMap;

    public HealthierCaterersMap() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View RootView =  inflater.inflate(R.layout.fragment_healthier_caterers_map, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        try {
            KmlLayer layer = new KmlLayer(mMap, R.raw.caterers, getActivity().getApplicationContext());
            layer.addLayerToMap();
